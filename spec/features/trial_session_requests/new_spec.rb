...
describe 'Creating trial session request' do
  it 'creates a trial session request and sends an email' do
    ...
    expect(mails_for_vistor.last).to be_delivered_from("Accessibility Doctor (A11y-Doc) <help@accessibility-doctor.com>")
    ...
    expect(mails_for_doctor.last).to be_delivered_from("Accessibility Doctor (A11y-Doc) <help@accessibility-doctor.com>")
    expect(mails_for_doctor.last).to be_delivered_to("Accessibility Doctor (A11y-Doc) <help@accessibility-doctor.com>")
